...
$sql = "
    SELECT
        ...
        -- FIXED: Use shift start and end times directly for expected times
        s.start_time as expected_first_in,
        s.end_time as expected_last_out,
    ...
    {$where_sql}
    GROUP BY
        u.id, u.full_name, u.employee_code, attendance_date, s.shift_name, s.start_time, s.end_time, s.is_night_shift, s.grace_in_minutes, s.grace_out_minutes
    ORDER BY
        u.full_name ASC
";
