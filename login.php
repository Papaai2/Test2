    ...
    if (empty($email) || empty($password)) {
        ...
        try {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                $stmt_check_password_change = $pdo->prepare("SELECT must_change_password FROM users WHERE id = ?");
                $stmt_check_password_change->execute([$user['id']]);
                $must_change_password = $stmt_check_password_change->fetchColumn();
